...
export default function ProjectCard({ project }: ProjectCardProps) {
  const Card = (
    <motion.article
      ...
      className="group relative bg-[#111] border border-white/[0.08] rounded-2xl p-7 shadow-[0_0_40px_rgba(0,0,0,0.6)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_60px_rgba(0,0,0,0.8)] hover:border-white/[0.15] flex flex-col h-full"
    >
